...
//| CLAIRE                                                      |
//| cgen.cl                                                     |
//| Copyright (C) 1994 - 2016 Yves Caseau. All Rights Reserved  |
...
[interface!(c:c_producer, self:class) : void
 ->  if (self = void) princ("void ")
     else if (self = integer) princ("Cint ")                   // v3.5
...
[to_cl(c:c_producer,x:any,s:class,loop:any) : void
 -> if (s = void) printf("_void_(~I)", expression(x, loop))
       ...
       (if (x = true) printf("Kernel.ctrue")
        ...
        printf("ClAlloc->import(~I,(Cint *) ~I)", expression(s, {}),   // v3.5
                                         expression(x, loop))
              ...
              (printf("~I// interface method ~I", breakline(), breakline()),
               ...
               printf("\t{ ~I~I;}\n~I",
                      ...
                      (if (p.mClaire/dispatcher > 0)
                          printf("~I->fcall((Cint) this~I)",                // v3.5
                                 expression(p,nil),
                                 (for v in %vars
                                     (princ(",(Cint) "), expression(v,nil))))
