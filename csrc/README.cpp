/** @package 
        ...
        Author: YVES CASEAU
        Created: YC  03/07/2016 10:45:13
	Last change: YC 03/07/2016 15:30:33
*/
/***********************************************************************/
...
// ******************************************
// * CLAIRE 3.5 : version 64 bits           *
// ******************************************

started on July 3 rd

(a) claire.h
   - create Cint = int or long
   - create Cadr = long * ?
   - OID may be int or long (64 bits)
   - CCAST (macro for MACos


(b) marie.h

(c) Kernel.h
    any method that is used by CLAIRE or any slot must use Cint


// BUG code!!
- clString :  substring_string
- clString :  exp_integer (bounds are false for 64 bits)
