...
{ { ClaireBoolean *Result ;
    if (Kernel._set == self->isa)
     ...
     { Cint  n = CLREAD(ClaireClass,self,open);
...
{ { bag *Result ;
    { ClaireObject *V_CC ;
      ...
      else close_exception(((general_error *) (*Core._general_error)(_string_(CSTRING("[178] cannot enumerate ~S")),
...
Interval * _dash_dash_integer(Cint x,Cint y)
{ { Interval *Result ;
    { ClaireObject *V_CC ;
      if (x <= y)
       V_CC = _dot_dot_integer(x,y);
      else close_exception(((general_error *) (*Core._general_error)(_string_(CSTRING("[182] the interval (~S -- ~S) is empty")),
  ...
  { ClaireType *Result ;
    { ClaireObject *V_CC ;
      if ((self == Kernel._set) || 
       ...
       close_exception(((general_error *) (*Core._general_error)(_string_(CSTRING("[177] subtyping of ~S not allowed")),
  ...
  { ClaireType *Result ;
    { ClaireObject *V_CC ;
      if (((self == Kernel._list) || 
       ...
       close_exception(((general_error *) (*Core._general_error)(_string_(CSTRING("[177] the subtyping expression ~S[~A] is not allowed")),
...
{ GC_BIND;
  princ_string(CSTRING("<ref:"));
  print_any(GC_OID(_oid_(self->args)));
  princ_string(CSTRING("(ltype["));
...
Cint  size_collection(ClaireCollection *x)
{ GC_BIND;
  { Cint Result = 0;
      ...
      { OID gc_local;
        ...
        { GC_LOOP;
          if ((INHERIT(OBJECT(ClaireClass,c),Kernel._primitive)) && 
           ...
           close_exception(((general_error *) (*Core._general_error)(_string_(CSTRING("[178] cannot enumerate ~S")),
...
Cint  size_class(ClaireClass *self)
{ { Cint Result = 0;
    { Cint  n = 0;
      { ITERATE(x);
...
Cint  size_Union(Union *x)
{ if ((INHERIT(x->t1->isa,Core._Interval)) || 
      (Kernel._set == x->t1->isa)) 
  { { Cint Result = 0;
      Result = ((Core.size->fcall(((Cint) OBJECT(ClaireObject,GC_OID(_oid_(x->t1))))))+(Core.size->fcall(((Cint) OBJECT(ClaireObject,GC_OID(_oid_(x->t2)))))));
      return (Result);} 
     } 
  else{ GC_BIND;
    { Cint Result = 0;
...
Cint  size_Interval(Interval *self)
...
Cint  size_subtype(subtype *x)
{ if (x->arg == Kernel._set) 
  { { Cint Result = 0;
      Result = exp2_integer(Core.size->fcall(((Cint) OBJECT(ClaireObject,GC_OID(_oid_(x->t1))))));
      return (Result);} 
     } 
  else{ GC_BIND;
    { Cint Result = 0;
...
Cint  size_tuple(tuple *l)
{ { Cint Result = 0;
    if (boolean_I_any(_oid_(l)) != CTRUE)
     Result = 1;
    else { Cint  m = (*Core.size)((*(l))[1]);
        { Cint  n = 2;
          Cint  g0111 = l->length;
          { while ((n <= g0111))
            { m= (m*((*Core.size)((*(l))[n])));
      ...
      if (INHERIT(y->isa,Core._Union))
       ...
       V_CC = CTRUE;
          ...
          { ClaireObject * m = GC_OBJECT(ClaireObject,find_which_property(Kernel._Z,start,OWNER(x)));
            ...
            else close_exception(((general_error *) (*Core._general_error)(_string_(CSTRING("[179] (~S % ~S): not implemented!")),
...
{ GC_BIND;
  { ClaireType *Result ;
    if (Kernel._set == x->isa)
    ...
    else if ((OBJECT(ClaireBoolean,_oid_((ClaireObject *) Core._inf_equalt->fcall(((Cint) y),((Cint) x))))) == CTRUE)
     Result = x;
    else if ((OBJECT(ClaireBoolean,_oid_((ClaireObject *) Core._inf_equalt->fcall(((Cint) x),((Cint) y))))) == CTRUE)
     Result = y;
     ...
     { Cint  a = CLREAD(Interval,x,arg1);
      Cint  b = CLREAD(Interval,x,arg2);
...
/* The c++ function for: ..(x:integer,y:integer) [NEW_ALLOC] */
ClaireType * _dot_dot_integer(Cint x,Cint y)
{ { ClaireType *Result ;
    if (x <= y)
...
{ GC_BIND;
  { ClaireBoolean *Result ;
    { ClaireType * z = GC_OBJECT(ClaireType,of_bag(s));
      if (equal(_oid_(z),_oid_(Kernel.emptySet)) != CTRUE)
       Result = OBJECT(ClaireBoolean,_oid_((ClaireObject *) Core._inf_equalt->fcall(((Cint) z),((Cint) y))));
      else { OID  g0118UU;
          { ITERATE(x);
...
{ GC_BIND;
  { ClaireBoolean *Result ;
    Result = (((OBJECT(ClaireBoolean,_oid_((ClaireObject *) Core._inf_equalt->fcall(((Cint) OBJECT(ClaireObject,GC_OID(_oid_(x->t1)))),((Cint) y))))) == CTRUE) ? (((OBJECT(ClaireBoolean,_oid_((ClaireObject *) Core._inf_equalt->fcall(((Cint) OBJECT(ClaireObject,GC_OID(_oid_(x->t2)))),((Cint) y))))) == CTRUE) ? CTRUE: CFALSE): CFALSE);
    GC_UNBIND; return (Result);} 
  } 
...
{ GC_BIND;
  { ClaireBoolean *Result ;
    Result = ((INHERIT(y->isa,Core._Interval)) ?
      ...
      ((Kernel._set == y->isa) ?
        OBJECT(ClaireBoolean,_oid_((ClaireObject *) Core._inf_equalt->fcall(((Cint) OBJECT(ClaireObject,GC_OID(_oid_(set_I_Interval(x))))),((Cint) y)))) :
...
{ GC_BIND;
  { ClaireBoolean *Result ;
    if (INHERIT(y->isa,Core._Param))
     { ClaireBoolean *v_and;
      { v_and = OBJECT(ClaireBoolean,_oid_((ClaireObject *) Core._inf_equalt->fcall(((Cint) x),((Cint) CLREAD(Param,y,arg)))));
        if (v_and == CFALSE) Result =CFALSE; 
        else { { OID  g0125UU;
            { Cint  n = 1;
              Cint  g0124 = CLREAD(Param,y,params)->length;
              { OID gc_local;
      ...
      CTRUE :
      ((INHERIT(y->isa,Core._subtype)) ?
        (((OBJECT(ClaireBoolean,_oid_((ClaireObject *) Core._inf_equalt->fcall(((Cint) x),((Cint) CLREAD(subtype,y,arg)))))) == CTRUE) ? (((OBJECT(ClaireBoolean,_oid_((ClaireObject *) Core._inf_equalt->fcall(((Cint) OBJECT(ClaireObject,GC_OID(_oid_(member_type(x))))),((Cint) OBJECT(ClaireObject,GC_OID(_oid_(CLREAD(subtype,y,t1))))))))) == CTRUE) ? CTRUE: CFALSE): CFALSE) :
...
{ return (OBJECT(ClaireBoolean,_oid_((ClaireObject *) Core._inf_equalt->fcall(((Cint) x),((Cint) y)))));} 
...
{ GC_BIND;
  { ClaireType *Result ;
    if (INHERIT(x->isa,Kernel._class))
     ...
     { Cint  i = index_list(CLREAD(Param,x,params),_oid_(p));
      Result = ((i > 0) ?
...
OID  nth_array(OID *self,Cint x)
{ { OID Result = 0;
    if ((x > 0) && 
        (x <= self[0]))
     Result = nth_get_array(self,x);
    else { OID  V_CL0129;close_exception(((general_error *) (*Core._general_error)(_string_(CSTRING("[180] nth[~S] out of scope for ~S")),
...
list * make_list_integer2(Cint n,ClaireType *t,OID x)
