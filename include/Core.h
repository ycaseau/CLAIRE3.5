// interface defination for module Core, Sun May 28 08:25:54 2017
#ifndef CLAIREH_Core
#define CLAIREH_Core
...
class Reference: public Type{ 
  public:
     ...
     ClaireBoolean *arg;} 
;
extern OID  eval_message_property(property *self,ClaireObject *r,Cint start,ClaireBoolean *int_ask);
extern OID  noeval_message_property2(property *self,Cint start);
extern OID  execute_method(method *self,Cint start,ClaireBoolean *int_ask);
...
extern void  put_property1(property *p,ClaireObject *x,Cint n,ClaireClass *s,OID y);
extern void  update_property(property *p,ClaireObject *x,Cint n,ClaireClass *s,OID y);
...
extern void  add_I_property(property *self,ClaireObject *x,Cint n,OID y);
extern ClaireBoolean * add_value_property(property *self,ClaireObject *x,Cint n,bag *l,OID y);
...
extern ClaireBoolean * matching_ask_list(list *l,Cint n,Cint m);
extern ClaireBoolean * vmatch_ask_any(OID t,OID x,Cint n);
extern ClaireBoolean * tmatch_ask_list(list *l,list *l2);
extern ClaireBoolean * tmatch_ask_any(OID t,OID t2,list *l);
extern ClaireObject * find_which_property(property *p,Cint n,ClaireClass *c);
extern ClaireObject * find_which_list(list *l,ClaireClass *c,Cint n,Cint m);
extern ClaireObject * find_which_class(ClaireClass *c,list *l,Cint n,Cint m);
extern OID  release_void();
extern OID  about_void();
extern list * get_args_integer(Cint i);
...
extern void  push_debug_property(property *prop,Cint arity,Cint start);
extern void  pop_debug_property(property *self,Cint n,OID val);
extern void  tr_indent_boolean(ClaireBoolean *return_ask,Cint n);
...
extern ClaireBoolean * add_value_array(table *self,Cint n,bag *l,OID y);
...
extern Cint  get_index_table1(table *a,OID x);
extern Cint  get_index_table2(table *a,Cint x,Cint y);
...
extern OID  tformat_string(char *self,Cint i,list *l);
...
extern Cint  buffer_length_void();
extern void  buffer_set_length_integer(Cint i);
...
extern ClaireBoolean * short_enough_integer(Cint self);
...
extern OID  store_list4(list *l,Cint n,OID y);
extern OID  store_array1(OID *l,Cint n,OID y);
extern void  commit_integer(Cint n);
extern void  backtrack_integer(Cint n);
...
extern ClaireChar * nth_get_string(char *s,Cint n,Cint max);
extern void  nth_put_string(char *s,Cint n,ClaireChar *c,Cint max);
extern char * make_string_symbol(symbol *self);
extern void  self_print_symbol_Core(symbol *self);
extern Cint  _plus_integer(Cint self,Cint x);
extern ClaireType * _plus_integer_type(ClaireType *self,ClaireType *x);
extern Cint  _dash_integer1(Cint self,Cint x);
extern ClaireType * _dash_integer1_type(ClaireType *self,ClaireType *x);
extern Cint  _inf_inf_integer(Cint x,Cint y);
extern Cint  _sup_sup_integer(Cint x,Cint y);
extern Cint  and_integer(Cint x,Cint y);
extern Cint  or_integer(Cint x,Cint y);
extern ClaireBoolean * _inf_integer(Cint self,Cint x);
extern ClaireBoolean * _inf_equal_integer(Cint self,Cint x);
extern ClaireBoolean * _sup_integer(Cint self,Cint x);
extern ClaireBoolean * nth_integer(Cint self,Cint y);
extern Cint  abs_integer(Cint x);
extern Cint  random_integer2(Cint a,Cint b);
extern ClaireBoolean * factor_ask_integer(Cint x,Cint y);
extern ClaireBoolean * divide_ask_integer(Cint x,Cint y);
...
extern void  printFDigit_float(double x,Cint i);
extern void  printFDigit_float_(OID g0092,Cint g0093);
extern void  printFDigit_integer(Cint x,Cint i);
extern Cint  length_bag(bag *self);
extern OID  nth_bag(bag *self,Cint x);
extern ClaireType * nth_bag_type(ClaireType *self,ClaireType *x);
extern OID  nth_get_bag(bag *self,Cint x);
...
extern OID  nth_set_list(list *self,Cint x,OID y);
extern OID  car_list(list *self);
extern list * hashlist_integer(Cint n);
extern Cint  hashsize_list(list *l);
extern list * sort_method(method *f,list *self);
extern void  quicksort_list(list *self,method *f,Cint n,Cint m);
extern set * build_powerset_list(list *self);
extern list * make_copy_list_integer(Cint n,OID d);
extern set * difference_set(set *self,set *x);
extern void  nth_equal_array(OID *self,Cint x,OID y);
...
extern Interval * _dash_dash_integer(Cint x,Cint y);
...
extern Cint  size_collection(ClaireCollection *x);
extern set * set_I_set(set *x);
extern Cint  size_set(set *x);
extern Cint  size_list2_Core(list *x);
extern set * set_I_class(ClaireClass *x);
extern Cint  size_class(ClaireClass *self);
extern set * set_I_Union(Union *x);
extern Cint  size_Union(Union *x);
extern set * set_I_Interval(Interval *x);
extern Cint  size_Interval(Interval *self);
extern set * set_I_Param(Param *x);
extern Cint  size_Param(Param *x);
extern set * set_I_subtype(subtype *x);
extern Cint  size_subtype(subtype *x);
extern set * set_I_tuple(tuple *x);
extern Cint  size_tuple(tuple *l);
...
extern ClaireType * _dot_dot_integer(Cint x,Cint y);
...
extern Cint  integer_I_set(set *s);
extern set * make_set_integer(Cint x);
...
extern OID  nth_array(OID *self,Cint x);
...
extern list * make_list_integer2(Cint n,ClaireType *t,OID x);
