// interface defination for module Language, Sun May 28 08:25:56 2017
...
extern OID  lexical_build_any(OID self,list *lvar,Cint n);
...
extern OID  lbreak_integer(Cint n);
extern OID  indent_integer(Cint limit);
extern void  set_level_void();
extern void  set_level_integer(Cint n);
extern OID  printbox_bag1(bag *self,Cint start,Cint finish,char *s);
...
extern Cint  occurrence_any(OID self,Variable *x);
...
extern Cint  bit_vector_listargs2(listargs *l);
